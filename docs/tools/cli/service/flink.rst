...
* ``cpu FLOAT, node INT, cpu_in_percent INT, occurred_at TIMESTAMP_LTZ(3)`` as **SQL schema**
...
::
  ...
  avn service flink table create flink-devportal-demo ab8dd446-c46e-4979-b6c0-1aad932440c9  \
    ...
    --schema-sql "cpu FLOAT, node INT, cpu_in_percent INT, occurred_at TIMESTAMP_LTZ(3)"
...
* ``INSERT INTO KAlert SELECT * FROM KCpuIn WHERE cpu_in_percent > 70`` as **SQL statement**
* ``flink-devportal-demo`` as service name
...
::
  ...
  avn service flink job create flink-devportal-demo JobExample                        \
    ...
    --statement "INSERT INTO KAlert SELECT * FROM KCpuIn WHERE cpu_in_percent > 70"
