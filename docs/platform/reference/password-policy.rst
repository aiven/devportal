...
Selecting a strong password is a first step in securing your account. To know more about how you can strengthen your security by adding a two factor authentication, please refer to `Manage two-factor authentication </docs/platform/howto/user-2fa>`_.
