...
- Service **overview** page in `the Aiven Console <https://console.aiven.io/>`_

- ``avn service get`` command in `the Aiven CLI <https://docs.aiven.io/docs/tools/cli/service#avn-service-get>`_

- ``service`` endpoint in `the Aiven REST API <https://api.aiven.io/doc/#tag/Service/operation/ServiceGet>`_
