...
Aiven service power off and power on are different from that on a traditional platform. For better utilization of resources on the Aiven platform, idle resources will be released and only the necessary data will be kept after a power off. The impact on the service is different depending on the service type and plan. 
