...
* Create a `fork :doc:/docs/platform/concepts/database-forking` of Aiven for OpenSearch from your existing Aiven for Elasticsearch service. This is a good way to get a fast preview of how Aiven for OpenSearch will work for you.
