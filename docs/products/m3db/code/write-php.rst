...
If the script outputs ``bool(true)`` then there is data in your M3DB. If you'd like to you can take a look at :doc:`../guides/grafana` to see how to inspect your data with Grafana.
