Create a sink connector from Apache Kafka® to OpenSearch®
=========================================================
...
6. Paste the connector configuration (stored in the ``opensearch_sink.json`` file) in the form.
7. Select **Apply**.
...
10. Verify the presence of the data in the target OpenSearch service, the index name is equal to the Apache Kafka topic name.
