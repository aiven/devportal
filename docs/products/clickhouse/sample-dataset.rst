...
We will be using the ClickHouse client to connect to the server. Follow :doc:`the separate guide <howto/connect-to-ch-service>` to familiarize yourself with how to set up and start using the ClickHouse client.
