...
Based on the Datadog `Postgres integration documentation <https://docs.datadoghq.com/integrations/postgres/?tab=host#data-collected>`_, there are a variety of different metrics recorded by the Datadog agent. However, only some of these are available in Aiven for PostgreSQL services.
