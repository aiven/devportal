...
1. Download the ``pagila-data.sql`` from our `GitHub repository <https://github.com/aiven/devportal/blob/jojo-pagila-sample-database/code/products/postgresql/pagila/pagila-data.sql>`_.

.. Tip::
    You may use the following command on your terminal::

        wget https://raw.githubusercontent.com/aiven/devportal/jojo-pagila-sample-database/code/products/postgresql/pagila/pagila-data.sql
...
The `source code for the Pagila database <https://github.com/aiven/devportal/tree/jojo-pagila-sample-database/code/products/postgresql/pagila>`_ is available from our repository.
