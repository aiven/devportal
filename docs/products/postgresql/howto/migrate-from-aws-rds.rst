Migrate from RDS PostgreSQL® to Aiven for PostgreSQL® with ``aiven-db-migrate``
===============================================================================

``avn`` Aiven CLI simplifies PostgreSQL®ß database migration with ``aiven-db-migrate`` without down time.
