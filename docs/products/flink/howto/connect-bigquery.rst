...
Once you have completed these steps, the integration will be ready. You can now start creating :doc:`Aiven for Apache Flink applications <../howto/create-flink-applications>` that use Google BigQuery as a sink. 
