...
Frequently results in Apache Flink® data pipelines include one or more timestamps, either contained in the :doc:`source events `/docs/products/flink/concepts/event-processing-time` or generated by :doc:`window aggregations `/docs/products/flink/concepts/windows`.
